...
public class MainActivity extends AppCompatActivity {
    ...
    // create a list of music tracks for the recycler view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialise the list of songs
        for(int i =0; i < 20; i++){
            songs.add("Song "+i);
        }

        // Link the Recycler view to the Adaptor
        songListRecyclerView = findViewById(R.id.song_list);
        songAdapter          = new SongListAdapter(this, songs);
